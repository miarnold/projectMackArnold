...
CREATE TABLE `cars` (
  ...
  CONSTRAINT `cars_ibfk_1` FOREIGN KEY (`user_name`) REFERENCES `users` (`user_name`)
...
INSERT INTO `users` VALUES ('admin','admin',NULL,'Mack','Arnold','arnoldmack27@gmail.com');
...
-- Dump completed on 2017-10-04 19:43:01
